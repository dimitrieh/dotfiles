...
filter 'design.gitlab.com' '.project.path == "design.gitlab.com"'
filter 'merge requests' '.target_type == "MergeRequest"'
filter 'Milestone 11.8' '.target.milestone.title == "11.8"'
filter 'Milestone 11.9' '.target.milestone.title == "11.9"'
...
filter 'Josh' '.author.username == "joshlambert"'
filter 'Kenny' '.author.username == "kencjohnston"'
filter 'Package label' '.target.labels[]? == "Package"'
