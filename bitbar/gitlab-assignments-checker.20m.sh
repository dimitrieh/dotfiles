...
echo "---";
file=/tmp/gitlab-assignments-checker-1-star-emoji.txt
> $file
echo "Assigned issues which you have awarded a star emoji | bash=/Users/dimitrie/.dotfiles/bin/openlist param1=$file terminal=false color=$headercolor";
while read -r iid
      read -r labels
      read -r title
      read -r web_url; do
...
echo "---";
file=/tmp/gitlab-assignments-checker-1-gitlab-design-system.txt
> $file
echo "Assigned issues on design system | bash=/Users/dimitrie/.dotfiles/bin/openlist param1=$file terminal=false color=$headercolor";
while read -r iid
      read -r labels
      read -r title
      read -r web_url; do
...
echo "---";
file=/tmp/gitlab-assignments-checker-1-milestone-11-9.txt
> $file
echo "Assigned issues with milestone 11.9 | bash=/Users/dimitrie/.dotfiles/bin/openlist param1=$file terminal=false color=$headercolor";
while read -r iid
      read -r labels
      read -r title
      read -r web_url; do
...
| href=$web_url font=$monofont";
echo $web_url >> $file;
done < <(jq -rc '.[] | select(.milestone.title == "11.9") | .iid,.labels,.title,.web_url' < /tmp/gitlab-assignments-checker-1-1.json);

echo "---";
file=/tmp/gitlab-assignments-checker-1-milestone-11-10.txt
> $file
echo "Assigned issues with milestone 11.10 | bash=/Users/dimitrie/.dotfiles/bin/openlist param1=$file terminal=false color=$headercolor";
while read -r iid
      read -r labels
      read -r title
      read -r web_url; do
...
| href=$web_url font=$monofont";
echo $web_url >> $file;
done < <(jq -rc '.[] | select(.milestone.title == "11.10") | .iid,.labels,.title,.web_url' < /tmp/gitlab-assignments-checker-1-1.json);

echo "---";
file=/tmp/gitlab-assignments-checker-1-milestone-11-11.txt
> $file
echo "Assigned issues with milestone 11.11 | bash=/Users/dimitrie/.dotfiles/bin/openlist param1=$file terminal=false color=$headercolor";
while read -r iid
      read -r labels
      read -r title
      read -r web_url; do
...
| href=$web_url font=$monofont";
echo $web_url >> $file;
done < <(jq -rc '.[] | select(.milestone.title == "11.11") | .iid,.labels,.title,.web_url' < /tmp/gitlab-assignments-checker-1-1.json);
...
echo "---";
file=/tmp/gitlab-assignments-checker-1-milestone-12-1.txt
> $file
echo "Assigned issues with milestone 12.1 | bash=/Users/dimitrie/.dotfiles/bin/openlist param1=$file terminal=false color=$headercolor";
while read -r iid
      read -r labels
      read -r title
      read -r web_url; do
...
echo "---";
file=/tmp/gitlab-assignments-checker-1-milestone-12-2.txt
> $file
echo "Assigned issues with milestone 12.2 | bash=/Users/dimitrie/.dotfiles/bin/openlist param1=$file terminal=false color=$headercolor";
while read -r iid
      read -r labels
      read -r title
      read -r web_url; do
...
echo "---";
file=/tmp/gitlab-assignments-checker-1-verify.txt
> $file
echo "Assigned issues with label Verify | bash=/Users/dimitrie/.dotfiles/bin/openlist param1=$file terminal=false color=$headercolor";
while read -r iid
      read -r labels
      read -r title
      read -r web_url; do
...
> $file
echo "Assigned issues which you have created yourself | bash=/Users/dimitrie/.dotfiles/bin/openlist param1=$file terminal=false color=$headercolor";
while read -r iid
      read -r labels
      read -r title
      read -r web_url; do
